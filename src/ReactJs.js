        ...
        return (
            <div>
                ...
                <div className="mt-2 container-fluid p-5">
                    <div className="row">
                        <div className="col-3 d-none d-lg-block d-xl-block d-md-none"></div>
                        <div className="col-lg-6 col-sm-12  col-xs-12 col-md-12 text-center">
                            <h3 className="text-left">Introducing React Js</h3>
                            <br />
